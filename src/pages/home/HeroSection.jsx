          ...
          <div>
            <Link aria-label="Go to membership page" to="/membership">
              <motion.button
                ...
                aria-label="Button"
                className="mt-9 border border-gymGreen bg-gymGreen text-white text-sm px-10 py-4 rounded-full hover:duration-300 xl:px-12 xl:py-5 xl:hover:bg-transparent"
              >
                {t("navigation.navCta")}
              </motion.button>
            </Link>
