  ...
  return (
    <div className="relative lg:h-[1290px]">
      <div className="lg:grid-row-2 lg:grid lg:mx-20 lg:absolute bg-white lg:w-[92%] xl:h-[1300px] lg:top-[-160px]">
        <div className="h-[790px] sm:h-[770px] lg:h-full">
          <div className="lg:grid grid-cols-2">
            ...
            <div className="text-center xl:text-left lg:text-left pb-4 h-96 xl:h-full flex lg:h-full flex-col justify-center px-4 items-center pt-9 sm:pt-0">
              <motion.div
                initial={{ opacity: 0 }}
                whileInView={{
                  opacity: 1,
        ...
        <div className="h-[790px] sm:h-[770px] lg:h-full">
          <div className="lg:grid grid-cols-2 ">
            ...
            <div className="text-center pt-9 sm:pt-0 lg:h-full pb-4 xl:text-left lg:text-left h-96 flex flex-col justify-center order-1 px-4 items-center">
              <motion.div
                initial={{ opacity: 0 }}
                whileInView={{
                  opacity: 1,
